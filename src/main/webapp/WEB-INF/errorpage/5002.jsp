...
.clear { zoom: 1 }
body {
    background: #dfdfdf url(../img/bg_noise.jpg) repeat;
...
.logo {
    position: absolute;
    background: url(../img/guidelogo.png);
    width: 200px;
    height: 80px;
    top: 1%;
    left: 1%;
...
<div id="wrapper">
  <div id="main">
    ...
    <div id="content">
      <h2>抱歉,您登录有异常！</h2>
      <p>当您看到这个页面,表示您的登录有异常,请您重新访问登录页面！</p>
      <div class="utilities">
        <a class="button right" href="#" onClick="history.go(-1);return true;">返回...</a><a class="button right" href="/GuideVisual">登录页面</a>
        <div class="clear"></div>
      </div>
    </div>
